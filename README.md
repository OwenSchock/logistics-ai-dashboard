...
* **Security Architecture:** Vercel Serverless Functions (Node.js) for secure, backend API key management and request handling.
...
🔗 **[Get the Master Portfolio Dataset here](https://github.com/OwenSchock/logistics-ai-dashboard/blob/main/master_portfolio_dataset.csv)** *(Click the "Download raw file" icon in the top right corner of the GitHub file preview).*